...
public class ReflectionBenchmark {
    ...
    private final static long SECONDS = 5L;
    ...
    public void setup()
        throws Throwable {
        student = new Student("Gosha", "Krymskiy");
    ...
    @SuppressWarnings("checkstyle:UncommentedMain") public static void main(String[] args) throws RunnerException {
        Options options = new OptionsBuilder()
            ...
            .warmupForks(1)
            .warmupIterations(1)
            .warmupTime(TimeValue.seconds(SECONDS))
